...
Elm.String = Elm.String || {};
Elm.String.Interpolate = Elm.String.Interpolate || {};
Elm.String.Interpolate.make = function (_elm) {
   "use strict";
   _elm.String = _elm.String || {};
   _elm.String.Interpolate = _elm.String.Interpolate || {};
   if (_elm.String.Interpolate.values) return _elm.String.Interpolate.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var applyInterpolation = F2(function (replacements,match) {
      var ordinalString = function (_p0) {    return A2($String.dropLeft,1,A2($String.dropRight,1,_p0));}(match.match);
      var ordinal = $String.toInt(ordinalString);
      var _p1 = ordinal;
      if (_p1.ctor === "Err") {
            return "";
         } else {
            var _p2 = A2($Array.get,_p1._0,replacements);
            if (_p2.ctor === "Nothing") {
                  return "";
               } else {
                  return _p2._0;
   ...
   var interpolationRegex = $Regex.regex("\\{\\d+\\}");
   var interpolate = F2(function (string,args) {
      var asArray = $Array.fromList(args);
      return A4($Regex.replace,$Regex.All,interpolationRegex,applyInterpolation(asArray),string);
   });
...
Elm.Ev3Dashboard.make = function (_elm) {
   ...
   var Model = F3(function (a,b,c) {    return {status: a,perception: b,motivation: c};});
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.h1,_U.list([$Html$Attributes.$class("text-center")]),_U.list([$Html.text("Robot Dashboard")]))
              ...
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("row")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("col-md-3")]),_U.list([A2(perceptionView,address,model.perception)]))
                      ,A2($Html.div,_U.list([$Html$Attributes.$class("col-md-1")]),_U.list([A2(motivationView,address,model.motivation)]))]))]));
   });
   ...
   var inputs = $List.concat(_U.list([statusInputs,perceptionInputs,motivationInputs]));
   ...
   var init = {ctor: "_Tuple2"
              ,_0: {status: statusInitModel,perception: perceptionInitModel,motivation: motivationInitModel}
              ,_1: $Effects.batch(_U.list([statusInitEffect,perceptionInitEffect,motivationInitEffect]))};
   ...
   var statusUpdate = F2(function (action,model) {
      var _p4 = action;
      switch (_p4.ctor)
      {case "SetPaused": var result = A2($Maybe.withDefault,model.paused,_p4._0);
           return {ctor: "_Tuple2",_0: _U.update(model,{paused: result}),_1: $Effects.none};
         case "SetActive": return {ctor: "_Tuple2",_0: _U.update(model,{active: _p4._0.active}),_1: $Effects.none};
         case "TogglePaused": return {ctor: "_Tuple2",_0: model,_1: togglePaused};
         case "SetRuntimeStats": return {ctor: "_Tuple2",_0: _U.update(model,{runtime: _p4._0}),_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var update = F2(function (action,model) {
      var _p5 = A2(motivationUpdate,action,model.motivation);
      var newMotivation = _p5._0;
      var motivationEffects = _p5._1;
      var _p6 = A2(perceptionUpdate,action,model.perception);
      var newPerception = _p6._0;
      var perceptionEffects = _p6._1;
      var _p7 = A2(statusUpdate,action,model.status);
      var newStatus = _p7._0;
      var statusEffects = _p7._1;
      return {ctor: "_Tuple2"
             ,_0: _U.update(model,{status: newStatus,perception: newPerception,motivation: newMotivation})
             ,_1: $Effects.batch(_U.list([statusEffects,perceptionEffects,motivationEffects]))};
   });
