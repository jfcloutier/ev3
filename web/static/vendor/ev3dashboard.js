...
Elm.Ev3Status.make = function (_elm) {
   ...
   var Model = F3(function (a,b,c) {    return {paused: a,active: b,runtime: c};});
   var initModel = A3(Model,false,true,{ramFree: -1,ramUsed: -1,swapFree: -1,swapUsed: -1});
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([A2($Html$Events.onClick,address,Status(TogglePaused))
                              ,$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "btn",_1: true}
                                                                  ,{ctor: "_Tuple2",_0: btnColor(model.paused),_1: true}]))]),
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         ...
         case "SetActive": return {ctor: "_Tuple2",_0: _U.update(model,{active: _p0._0.active}),_1: $Effects.none};
